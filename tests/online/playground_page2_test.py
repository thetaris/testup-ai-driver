...
class Testplayground_page2:
    ...
    def test_case_1(self, setup, data_file_path):
        logging.info('Starting test case 1: enter HelloWorld in the textbox on URL: https://thetaris.org/playground/?page=2')
        session_id = 1234
    ...
    def test_case_2(self, setup, data_file_path):
        logging.info('Starting test case 2: click ok on URL: https://thetaris.org/playground/?page=2')
        session_id = 1234
    ...
    def test_case_3(self, setup, data_file_path):
        logging.info('Starting test case 3: enter the text HelloWorld and then click ok on URL: https://thetaris.org/playground/?page=2')
        session_id = 1234
